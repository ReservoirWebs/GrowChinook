...
for month in months:
    ...
    try:
        ...
        results, growths, growths1, csv_headers, sens_inputs, SHORT_RESULTS, ax2, ax3 = bio.run_sensitivity(sens_factors, form.getvalue('Sens_Param'), vals.site_data, vals.starting_mass, vals.daph_data, vals.max_temp, vals.min_temp, "None_T_None_None.csv", None, None, ax2, ax3)
