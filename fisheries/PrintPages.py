...
def print_adv_sens_form(long_file_name, short_file_name, in_out, target):
    ...
    print('''  <b>Enter a Starting Mass for the fish. Then select a default Year, Month, and Site, which will be used to fill in any fields you may choose to leave blank.
                   ...
                   <div id="sec1">
                    ...
                    <div style="float:left;">
                        <label>Daphnia Density (thousand per m<sup>2</sup> surface)</label>Using:<input type="text" name="Total_Daphnia_Input_Name" id="TotDTextInID" oninput="TotDSlide.value = TotDTextInID.value" oninput="TotDOutID.value = TotDInID.value"> <br><br>
