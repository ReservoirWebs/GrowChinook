...
def get_vals(light_in, total_daphnia_in, daphnia_size_in, site, month, year):
    ...
    lights = {('Fall Creek', '2016'): {'April': 0.761, 'May': 0.435, 'June': 0.441,
                                       'July': 0.424, 'August': 0.396, 'September': 0.429},
              ('Hills Creek', '2016'): {'April': 0.522, 'May': 0.570, 'June': 0.387,
                                        'July': 0.488, 'August': 0.345, 'September': 0.315},
              ('Lookout Point', '2016'): {'April': 0.572, 'May': 0.468, 'June': 0.388,
                                          'July': 0.349, 'August': 0.390, 'September': 0.352},
              ('Fall Creek', '2015'): {'March': 0.969, 'April': 0.695, 'May': 0.710, 'June': 0.792,
                                       'July': 0.434, 'August': 0.426},
              ('Hills Creek', '2015'): {'March': 0.539, 'April': 0.580, 'May': 0.569,
                                        'June': 0.414, 'July': 0.284, 'August': 0.311},
              ('Lookout Point', '2015'): {'March': 0.602, 'April': 0.629, 'May': 0.398,
                                          'June': 0.386, 'July': 0.373, 'August': 0.381},
              ('Fall Creek', '2014'): {'June': 0.572, 'July': 0.433, 'August': 0.435},
              ('Hills Creek', '2014'): {'June': 0.447, 'July': 0.340, 'August': 0.274},
              ('Lookout Point', '2014'): {'June': 0.487, 'July': 0.342, 'August': 0.330}
             }
...
class Batch:
    def __init__(self, site_data, starting_mass, daphnia_data, temp_max,
        ...
        #self.DayLight = 10752
        self.DayLight = 850 # new equations based off of 850 lux at surface, the light intensity of a dull day
